...
const initialMessages = [
  ...
  },
  {
    id: '2',
    senderId: 'user',
    text: 'Здравствуйте! Хотел бы узнать подробнее о ЖК Орда',
  ...
  },
  {
    id: '3',
    senderId: 'manager-1',
    text: 'Отличный выбор! ЖК Орда — это наш флагманский проект в районе Нурсат. Сдача запланирована на 4 квартал 2026 года. Сейчас доступно 89 квартир от 1 до 3 комнат.',
